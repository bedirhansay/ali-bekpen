                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                <TrendingUp size={16} color="var(--income)" opacity={0.6} />
                                <Text style={{ color: 'rgba(255,255,255,0.4)', fontSize: 12, fontWeight: 700, textTransform: 'uppercase', marginBottom: 0 }}>Toplam Gelir</Text>
                            </div>
                            <Title level={4} style={{ color: 'var(--income)', margin: 0, fontWeight: 700, whiteSpace: 'nowrap' }}>
                        ...
                        <div style={{
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                <TrendingDown size={16} color="var(--expense)" opacity={0.6} />
                                <Text style={{ color: 'rgba(255,255,255,0.4)', fontSize: 12, fontWeight: 700, textTransform: 'uppercase', marginBottom: 0 }}>Toplam Gider</Text>
                            </div>
                            <Title level={4} style={{ color: 'var(--expense)', margin: 0, fontWeight: 700, whiteSpace: 'nowrap' }}>
                        ...
                        <div style={{
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                {isPositiveNet ? <TrendingUp size={16} color="#4ade80" /> : <TrendingDown size={16} color="#f87171" />}
                                <Text style={{ color: 'rgba(255,255,255,0.4)', fontSize: 12, fontWeight: 700, textTransform: 'uppercase', marginBottom: 0 }}>Net Kar</Text>
                            </div>
                            <Title level={4} style={{ color: isPositiveNet ? '#4ade80' : '#f87171', margin: 0, fontWeight: 800, whiteSpace: 'nowrap' }}>
